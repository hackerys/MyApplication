...
package com.jansen.myapplication.animat.layoutchange;
...
import com.jansen.myapplication.ImageLoaderTest;
...
public class LayoutChangesActivity extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                NavUtils.navigateUpTo(this, new Intent(this, ImageLoaderTest.class));
                return true;
    ...
    private void addItem() {
        ...
        mTransition.setAnimator(LayoutTransition.APPEARING, ObjectAnimator.ofFloat(newView, View.SCALE_X, 0f, 1f));
        mTransition.setAnimator(LayoutTransition.DISAPPEARING, ObjectAnimator.ofFloat(newView, View.SCALE_X, 1f, 0f));
